...
export default function AiChat({
    ...
    return (
        <div className="flex flex-col h-full overflow-hidden max-w-3xl mx-auto bg-slate-50 shadow-xl sm:rounded-2xl border border-slate-200">
            {/* Header */}
            <div className="flex-none bg-blue-900 px-6 py-4 shadow-md z-10">
            ...
            {/* Chat Verlauf */}
            <div className="flex-1 overflow-y-auto min-h-0 p-2 space-y-6 bg-slate-50">
                {messages.length === 0 ? (
            ...
            <div className="flex-none bg-white p-2 border-t border-slate-200">
                ...
                >
                    ...
                    <span className={"text-xs text-gray-500"}>
                        Die Daten werden <b>nicht</b> zu Trainingszwecken verwendet.
                    </span>
                </form>
            </div>
        </div>
